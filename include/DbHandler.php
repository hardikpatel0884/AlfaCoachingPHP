...
class DbHandler {
     ...
     * @param String $password User login password
     */
    public function createUser($phone, $password,$name,$gender,$qualification,$experience) {
        require_once 'PassHash.php';
        ...
        if (!$this->isUserExists($phone)) {
            ...
            // insert query
            $stmt = $this->conn->prepare("INSERT INTO user (phone_number,password,name,gender,qualification,experience,api_key,image,is_tutor) values(?, ?, ?, ?, ?,?,?,?,0)");
            $stmt->bind_param("ssssssss", $phone, $password_hash, $name,$gender,$qualification,$experience, $api_key,$image);
